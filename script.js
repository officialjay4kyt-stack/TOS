                ...
                if (embed) {
                    if (zone.url.startsWith("http")) {
                        ...
                        fetch(url+"?t="+Date.now()).then(response => response.text()).then(html => {
                            ...
                            popup.innerHTML = `All In One<a href="TOS" target="_blank" style="color:#004085; font-weight:bold;">https://gn-math.github.io</a>!`;
...
function loadPrivacy() {
    ...
    popupBody.innerHTML = `
        <div style="max-height: 60vh; overflow-y: auto;">
            ...
            <p>Contacts:</p>
            <ul>
                <li>Join our Discord server >> https://discord.gg/X5PCSzJV </a>, To Get updates about TOS Future plans</li>
                <li>Maybe Some SneakPeak as well</li>
            </ul>
            <p> Also If you find any Bugs report them on our discord server</a>.</p>
        </div>
    `;
    popupBody.contentEditable = false;
    document.getElementById('popupOverlay').style.display = "flex";
